...
public class MultistripesTest {
  ...
  public void test2Stripes() throws Exception {
    Topology topology = new Topology(distribution(version("10.2.0.0.144"), PackageType.KIT, LicenseType.TC_DB),
        tcConfig(version("10.2.0.0.144"), getClass().getResource("/terracotta/10/tc-config-multistripes1.xml")),
        tcConfig(version("10.2.0.0.144"), getClass().getResource("/terracotta/10/tc-config-multistripes2.xml")));
