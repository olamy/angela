...
public class MultistripesTest {
  ...
  public void test2Stripes() throws InterruptedException, ExecutionException {
    ...
    Topology topology = new Topology("MultistripesTest::test2Stripes", distribution(version("10.1.0-SNAPSHOT"), PackageType.KIT, LicenseType.TC_DB), tcConfig1, tcConfig2);
