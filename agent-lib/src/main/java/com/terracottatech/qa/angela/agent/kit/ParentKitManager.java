...
public class ParentKitManager {

  private static final Logger logger = LoggerFactory.getLogger(ParentKitManager.class);
  ...
  public ParentKitManager(final Distribution distribution) {
