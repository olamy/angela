...
public class KitResolverTest {
  ...
  public void testSagVersions() {
    Map<String, String> sagInstallers = new HashMap<String, String>() {{
      ...
      put("10.7.0", "SoftwareAGInstaller107_LATEST.jar");
    }};
    ...
    for (String testedVersion : sagInstallers.keySet()) {
      ...
      Tc10KitResolver kitResolver = new Tc10KitResolver();
      String sagInstallerName = kitResolver.getSAGInstallerName(version);
